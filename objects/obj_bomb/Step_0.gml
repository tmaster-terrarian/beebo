...
//v
var c = noone
if (place_meeting(x, y + vsp, oCrate)) || (place_meeting(x, y + vsp, obj_stone)) || (place_meeting(x, y + vsp, obj_enemy)) || (place_meeting(x, y + vsp, par_enemy) && instance_place(x, y + vsp, par_enemy).playerally == 0) || (place_meeting(x, y + vsp, obj_boss))
{
    explode();
}
