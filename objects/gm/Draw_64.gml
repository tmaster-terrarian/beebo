...
if(global.console == true)
{
    ...
    draw_set_font(global.fonts.console);
    ...
    draw_set_alpha(1);
    draw_text_ext(offs + 1, 144 - (offs + 15) + log_pos + global.fonts.offset, log_str, 10, 251);
    ...
    draw_set_alpha(1);
    if(cursor_timer <= 30)
        draw_text_ext(offs + 1, 144 - offs + 4 + global.fonts.offset, "> " + input_str + "_", 0, 1024);
    else
        draw_text_ext(offs + 1, 144 - offs + 4 + global.fonts.offset, "> " + input_str, 0, 1024);
}
